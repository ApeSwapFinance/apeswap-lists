...
const bills: BillsConfig[] = [
  ...
  },
  {
    ...
    tags: ['DAO'],
    shortDescription:
      'Plutus is an governance aggregator optimizing liquidity and rewards through plsASSETs and plvASSETs. It partners with protocols like Camelot, GMX, and Radiant, enabling users to stay liquid while earning and voting. The $PLUTUS token powers governance, with $xPLUTUS as the main DAO voting asset. Locking PLUTUS as bPLS unlocks full benefits.',
    fullDescription:
