...
const bills: BillsConfig[] = [
  ...
  },
  {
    ...
    tags: ['GameFi'],
    warningCard: `This token is currently only tradable on <a href="https://api.mexc.com/api/v3/avgPrice?symbol=UCOINUSDT" target="_blank" rel="noopener noreferrer" style="color: #6099c5">MEXC</a>`,
  },
  {
    index: 1158,
    cmcId: 34498,
