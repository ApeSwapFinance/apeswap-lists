  ...
  */
  {
    ...
    tags: ['Test'],
    feeInPayout: 1,
    minTier: LaunchBondTiers.Bronze,
  },
  // {
  //   index: 176,
  //   version: '2.1.0',
  ...
  //   },
  //   shortDescription:
  //     'The tiers on this bond have been modified for testing purposes. Some elements and images might be broken because of that, this will not happen in production',
  //   fullDescription: `asd`,
  //   tags: ['Test'],
  //   feeInPayout: 1,
  //   // minTier: LaunchBondTiers.Silver,
