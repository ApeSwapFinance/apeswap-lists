...
const bills: BillsConfig[] = [
  ...
  },
  {
    ...
    shortDescription: 'This is just a short description used to make a first deployment',
    fullDescription:
      'This is me trying to make a longer description to create a first deployment, I would appreciate if we can decide what text should we put here. Maybe we can get in contact with the project for that? Maybe we can ask ChatGPT? I do not know. What I do know for certain is that I will prepare some mate right now',
  },
  {
    index: 85,
    contractAddress: {
