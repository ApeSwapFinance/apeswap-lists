...
const farmsV2: FarmConfig[] = [
  ...
  {
    pid: 6,
    lpSymbol: lpTokens.bananaBnb.symbol,
    lpAddresses: {
      [ChainId.BSC]: lpTokens.bananaBnb.address[ChainId.BSC],
      [ChainId.BSC_TESTNET]: '',
    },
    tokenSymbol: tokens.banana.symbol,
    tokenAddresses: {
  ...
  {
    pid: 7,
    lpSymbol: lpTokens.bananaBusd.symbol,
    lpAddresses: {
      [ChainId.BSC]: lpTokens.bananaBusd.address[ChainId.BSC],
      [ChainId.BSC_TESTNET]: '',
    },
    tokenSymbol: tokens.banana.symbol,
    tokenAddresses: {
  ...
  {
    pid: 8,
    lpSymbol: lpTokens.bnbBusd.symbol,
    lpAddresses: {
      [ChainId.BSC]: lpTokens.bnbBusd.address[ChainId.BSC],
      [ChainId.BSC_TESTNET]: '',
    },
  ...
  },
  {
    pid: 64,
    image: 'MONSTA.svg',
    lpSymbol: lpTokens.monstaBnb.symbol,
    lpAddresses: {
      [ChainId.BSC]: lpTokens.monstaBnb.address[ChainId.BSC],
      [ChainId.BSC_TESTNET]: '',
    },
  ...
  {
    pid: 9,
    lpSymbol: lpTokens.bnbBtc.symbol,
    lpAddresses: {
      [ChainId.BSC]: lpTokens.bnbBtc.address[ChainId.BSC],
      [ChainId.BSC_TESTNET]: '',
    },
  ...
  {
    pid: 10,
    lpSymbol: lpTokens.bnbEth.symbol,
    lpAddresses: {
      [ChainId.BSC]: lpTokens.bnbEth.address[ChainId.BSC],
      [ChainId.BSC_TESTNET]: '',
    },
