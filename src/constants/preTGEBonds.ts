...
const preTGEBonds: PreTGEConfig[] = [
  ...
  },
  {
    ...
    warningCard:
      'This is a Pre-TGE Bond for bveCATX, redeemable for veCATX upon listing. bveCATX can be redeemed 1:1 for veCATX at a max lock of 2 years, enabling you to participate and earn rewards on Catex.',
  },
]
