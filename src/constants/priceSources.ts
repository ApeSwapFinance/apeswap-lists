...
const priceSources: Partial<Record<ChainId, Record<string, PriceSourceConfigs>>> = {
  ...
  [ChainId.BASE]: {
    ...
    '0xf7178122a087ef8f5c7bea362b7dabe38f20bf05': {
      ...
      source: PriceSource.Dexscreener,
      type: 'token',
      tokenAddress: '0xf7178122a087ef8f5c7bea362b7dabe38f20bf05',
    },
    ...
    '0xd88e4a97b9defbf2c8491ea0e48fcc7e043c775a': {
      name: 'Blink Galaxy',
      symbol: 'BG',
      decimals: 18,
      source: PriceSource.Mexc,
  ...
  [ChainId.MAINNET]: {
    ...
    '0x58e6c2103d61e985828fb6148cf56e225a745b5a': {
      name: 'Fake Precious Metals USD',
      symbol: 'fpmUSD',
      decimals: 18,
      source: PriceSource.Coingecko,
      id: 'precious-metals-usd',
      tokenAddress: '0x58e6c2103d61e985828fb6148cf56e225a745b5a',
    },
  ...
  [ChainId.HYPEREVM]: {
    ...
    '0x391121D817dA42ED3434d281aedBbcC416a2aF18': {
      ...
      source: PriceSource.Dexscreener,
      type: 'token',
      tokenAddress: '0x391121D817dA42ED3434d281aedBbcC416a2aF18',
    },
  ...
  [ChainId.APTOS]: {
    ...
    // TODO: remove test tokens from testnet
