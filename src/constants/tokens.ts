...
const tokens: Record<string, Token> = {
  ...
  tape: {
    symbol: 'tAPE',
    address: {
      [ChainId.APTOS]: '0xff27a471b7d44e2a8eae1b8693190d4322f4e28cd9a4dd9d8fff7ed74a47556e', //TODO: remove this dummy token after testing is over
    },
    decimals: {
      [ChainId.APTOS]: 8,
    },
    liquidityDex: {
      [ChainId.APTOS]: LiquidityDex.External,
    },
    active: true,
  },
  apt: {
  ...
  ast: {
    symbol: 'AST',
    address: {
      [ChainId.BSC]: '0xb98B2f39c82d2bE83dc12087ad71AB85376285e8',
    },
    decimals: {
      [ChainId.BSC]: 18,
    },
  ...
  acn: {
    symbol: 'ACN',
    address: {
      [ChainId.MAINNET]: '0x3e76dd57E649A263a532cC9bcC58b32A065fB2a4',
    },
    decimals: {
      [ChainId.MAINNET]: 18,
    },
  ...
  qorpo: {
    symbol: 'QORPO',
    address: {
      [ChainId.BSC]: '0x22514fFb0d7232a56F0c24090E7B68f179FAA940',
    },
    decimals: {
      [ChainId.BSC]: 18,
    },
  ...
  monstro: {
    symbol: 'MONSTRO',
    address: {
      [ChainId.BASE]: '0x1d3bE1CC80cA89DDbabe5b5C254AF63200e708f7',
    },
    decimals: {
      [ChainId.BASE]: 18,
    },
